...
export const smartAnalytic = {
  ...
  ADD_ANALYTIC_ITEM: 'ADD_ANALYTIC_ITEM',
  UPDATE_ANALYTIC_ITEM: 'UPDATE_ANALYTIC_ITEM',
  DELETE_ANALYTIC_ITEM: 'DELETE_ANALYTIC_ITEM',
  UPDATE_REMARK: 'UPDATE_ANALYTIC_ITEM_REMARK',
  CLEAR_ADD_SUCCESS: 'CLEAR_ADD_ANALYTIC_ITEM_SUCCESS',
  CLEAR_UPDATE_SUCCESS: 'CLEAR_UPDATE_ANALYTIC_ITEM_SUCCESS',
  CLEAR_DELETE_SUCCESS: 'CLEAR_DELETE_ANALYTIC_ITEM_SUCCESS',
  CLEAR_UPDATE_REMARK_SUCCESS: 'CLEAR_ANALYTIC_ITEM_UPDATE_REMARK_SUCCESS',
}

//CONSOLE_ACCOUNT_MANAGE
// 后台账号管理
export const consoleAccountManage = {
  FETCH_LIST: 'FETCH_CONSOLE_ACCOUNT_MANAGE_LIST',
  FETCH_ROLE_LIST: 'FETCH_CONSOLE_ACCOUNT_MANAGE_ROLE_LIST',
  ADD_CONSOLE_USER: 'ADD_CONSOLE_ACCOUNT_MANAGE_USER',
  UPDATE_CONSOLE_USER: 'UPDATE_CONSOLE_ACCOUNT_MANAGE_USER',
  DELETE_CONSOLE_USER: 'DELETE_CONSOLE_ACCOUNT_MANAGE_USER',
  RESET_CONSOLE_USER_PASSWORD: 'RESET_CONSOLE_ACCOUNT_MANAGE_USER_PASSWORD',
  UPDATE_REMARK: 'UPDATE_CONSOLE_ACCOUNT_REMARK',
  CLEAR_ADD_CONSOLE_USER_SUCCESS: 'CLEAR_ADD_CONSOLE_USER_SUCCESS',
  CLEAR_UPDATE_CONSOLE_USER_SUCCESS: 'CLEAR_UPDATE_CONSOLE_USER_SUCCESS',
  CLEAR_DELETE_CONSOLE_USER_SUCCESS: 'CLEAR_DELETE_CONSOLE_USER_SUCCESS',
  CLEAR_RESET_PASSWORD_SUCCESS: 'CLEAR_CONSOLE_USER_RESET_PASSWORD_SUCCESS',
  CLEAR_UPDATE_REMARK_SUCCESS: 'CLEAR_CONSOLE_USER_UPDATE_REMARK_SUCCESS',
}

// AUTHORITY_ROLE_MANAGE
// 权限分组管理
export const authorityRoleManage = {
  FETCH_LIST: 'FETCH_AUTHORITY_ROLE_MANAGE_LIST',
  FETCH_PAGE_LIST: 'FETCH_AUTHORITY_ROLE_MANAGE_PAGE_LIST',
  CANCEL_PERMISSION: 'CANCEL_AUTHORITY_ROLE_MANAGE_PERMISSION',
  ADD_ROLE: 'ADD_AUTHORITY_ROLE',
  ADD_PAGE_PERMISSION: 'ADD_AUTHORITY_PAGE_PERMISSION',
  DELETE_ROLE: 'DELETE_AUTHORITY_ROLE',
  UPDATE_ROLE: 'UPDATE_AUTHORITY_ROLE',
  UPDATE_PAGE_PERMISSION: 'UPDATE_AUTHORITY_PAGE_PERMISSION',
  DELETE_PAGE_PERMISSION: 'DELETE_AUTHORITY_PAGE_PERMISSION',
  UPDATE_REMARK: 'UPDATE_AUTHORITY_REMARK',
  CLEAR_ADD_ROLE_SUCCESS: 'CLEAR_ADD_AUTHORITY_ROLE_SUCCESS',
  CLEAR_UPDATE_ROLE_SUCCESS: 'CLEAR_UPDATE_AUTHORITY_ROLE_SUCCESS',
  CLEAR_DELETE_ROLE_SUCCESS: 'CLEAR_DELETE_AUTHORITY_ROLE_SUCCESS',
  CLEAR_ADD_PAGE_PERMISSION_SUCCESS: 'CLEAR_ADD_PAGE_PERMISSION_SUCCESS',
  CLEAR_UPDATE_PAGE_PERMISSION_SUCCESS: 'CLEAR_UPDATE_PAGE_PERMISSION_SUCCESS',
  CLEAR_DELETE_PAGE_PERMISSION_SUCCESS: 'CLEAR_DELETE_PAGE_PERMISSION_SUCCESS',
  CLEAR_UPDATE_REMARK_SUCCESS: 'CLEAR_UPDATE_AUTHORITY_REMARK_SUCCESS',
}
